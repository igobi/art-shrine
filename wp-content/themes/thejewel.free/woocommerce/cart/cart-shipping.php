...
$drop_down_class = (count( $available_methods ) > 1) ? "dropdown" : "";
    ...
    <td>
        <?php if ( ! empty( $available_methods ) ) : ?>
            ...
            <?php elseif ( get_option( 'woocommerce_shipping_method_format' ) === 'select' ) : ?>
                ...
                <select name="shipping_method[<?php echo $index; ?>]" data-index="<?php echo $index; ?>" id="shipping_method_<?php echo $index; ?>" class="shipping_method <?php echo $drop_down_class;?>">
