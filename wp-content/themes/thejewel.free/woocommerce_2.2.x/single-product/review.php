		...
		<div class="comment-text">
			...
			<?php else : ?>
				<p class="meta">
					...
					?>&ndash; <time itemprop="datePublished" time content="<?php echo get_comment_date('Y-m-d'); ?>" datetime="<?php echo get_comment_date('c'); ?>"><?php echo get_comment_date(__( get_option('date_format'), 'yit' )); ?></time>:
				</p>
			<?php endif; ?>
