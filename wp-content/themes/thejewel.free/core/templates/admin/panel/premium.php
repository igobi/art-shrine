<?php 
$landing = 'http://yithemes.com/themes/wordpress/the-jewelry-shop/?utm_source=yith-panel&utm_medium=wpadmin&utm_content=tab-premium-jewel&utm_campaign=yith-admin';
$live = 'http://demo.yithemes.com/thejewel/';
...
if ( false === ( $price = get_transient( 'yit_theme_price_' . get_template() ) ) ) {
    $requrl = 'http://yithemes.com/?wc-api=yit_theme_price&theme=boemia';
