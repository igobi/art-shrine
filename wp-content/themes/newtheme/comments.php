...
<!-- BEGIN Comments -->	
	...
	<p class="field"><?php echo theme_locals("logged_in_as"); ?> <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a>. <a href="<?php echo wp_logout_url(get_permalink()); ?>" title="<?php echo theme_locals("log_account"); ?>"><?php echo theme_locals("log_out"); ?></a></p>
